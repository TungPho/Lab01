...
namespace Lab001.Controllers
{
	public class StudentController : Controller
	{
		...
		[HttpPost]
		[Route("Admin/Student/Add")]
		public async Task<IActionResult> CreateAsync(Student s)
		{
